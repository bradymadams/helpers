...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_moonlander(
    ...
    UG_VALD,        KC_TRANSPARENT, KC_MS_BTN1, KC_MS_UP, KC_MS_BTN2, KC_TRANSPARENT, UG_HUED,                              // ROW 2 - LEFT
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [3] = {
        ...
        LED_OFF__, LED_GREEN, LED_GREEN, LED_OFF__, LED_WHITE,  // COL 3
        LED_OFF__, LED_GREEN, LED_GREEN, LED_OFF__, LED_WHITE,  // COL 4
        LED_OFF__, LED_GREEN, LED_GREEN, LED_OFF__, LED_WHITE,  // COL 5
        LED_OFF__, LED_OFF__, LED_OFF__, LED_OFF__,             // COL 6

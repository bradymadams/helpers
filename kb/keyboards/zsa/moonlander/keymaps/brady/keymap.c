...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  case QK_MODS ... QK_MODS_MAX: 
    ...
    case ST_MACRO_1:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_ESCAPE)SS_DELAY(100)  SS_LSFT(SS_TAP(X_SCLN))SS_DELAY(100)  SS_TAP(X_W)SS_DELAY(100)  SS_TAP(X_A)  SS_DELAY(100) SS_TAP(X_ENTER));
    }
    break;
    case ST_MACRO_2:
    if (record->event.pressed) {
    ...
    case ST_MACRO_3:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_P)SS_DELAY(50)  SS_TAP(X_Y)SS_DELAY(50)  SS_TAP(X_T)SS_DELAY(50)  SS_TAP(X_H)SS_DELAY(50)  SS_TAP(X_O)SS_DELAY(50)  SS_TAP(X_N)SS_DELAY(50)  SS_TAP(X_SPACE));
    }
    break;
